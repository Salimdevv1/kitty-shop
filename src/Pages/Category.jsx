        ...
        <div className='container2'>
            ...
            {/* <div className='categories-container'>
                {Database.map((e)=>(
                      ...
                      <Link to="/plushies" style={{textDecoration :"none" , color : "black"}}><center><div className='box'>
                        <img src={e.categoryImg} alt="" className='categ-img' />
                        <p style={{marginTop : 10 , fontWeight :"bold" , fontSize : 19}}>{e.categoryTitle}</p>
                    </div></center></Link>
